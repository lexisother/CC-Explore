...
sc.NewGameModeSelectDialog.inject({
    ...
    init(callback) {
        ...
        ig.lang.labels.sc.gui.menu['new-game'].dialogs.exploreDescription = "Explore the world of Shadoon."

        this.explore = new sc.NewGameModeDialogButton(ig.lang.get("sc.gui.menu.new-game.dialogs.explore"), 1);
